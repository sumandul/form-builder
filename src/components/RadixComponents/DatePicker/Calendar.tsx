...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      showOutsideDays
      onSelect={onSelect}
      className="m-0 !w-full rounded-lg p-[2px]"
      classNames={{
        months:
          'flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 mx-[0px] my-[0px]',
        month: 'm-[0px]',
        ...
        table: 'w-full p-2',
        cell: 'hover:bg-gray-200 overflow-hidden m-1',
        day: 'w-full px-[4px] py-[2px]',
