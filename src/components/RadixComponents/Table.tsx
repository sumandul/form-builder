...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('text-body-sm sticky top-0 z-10 [&_tr]:border-b', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    ref={ref}
    className={cn(
      'data-[state=selected]:bg-muted h-full w-full border-b transition-colors hover:bg-blue-50',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'bg-primary-400 border-r-[1px] border-white p-2 font-bold text-white [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
